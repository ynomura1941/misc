...
AdingoFluctCommon.prototype = {
     ...
     * @param url
     */
    addSnycTag : function (url) {
      var sync = window.document.createElement('script');
      sync.setAttribute('src', url);
      window.document.body.appendChild(sync);
    },
...
/*jslint debug: false, forin: true, laxbreak: true, indent: 2, sub: true, windows: true, browser: true, vars: false, white: true, onevar: false, undef: true, nomen: false, eqeqeq: true, plusplus: true, bitwise: true, regexp: false, newcap: true, immed: true, strict: false*/
